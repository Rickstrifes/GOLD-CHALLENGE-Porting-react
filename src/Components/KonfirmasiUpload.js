...
import HitunganMenit from "./HitunganMenit";
import "./KonfirmasiUpload.css";
import APIOrder from "../apis/APIOrder";

const KonfirmasiUpload = ({ orderId }) => {
    ...
    <section className="confirm-upload">
      ...
      <Form onSubmit={onSubmit} className="upload-img">
        ...
        <Form.Group controlId="slipUpload">
          <Form.Control name="slip" type="file" accept="image/*" onChange={imageHandler} hidden />
        </Form.Group>
        {img === PlaceHolder ? (
          <Button
            type="button"
...
export default KonfirmasiUpload;
