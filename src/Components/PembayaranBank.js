...
import HitunganHari from "./HitunganHari";
import KonfirmasiUpload from "./KonfirmasiUpload";
import "./PembayaranBank.css";

const PembayaranBank = () => {
    ...
    <section className="bank-payment">
      ...
      {loading ? (
        <div className="rotating-lines-loading">
          <RotatingLines height="80" width="80" color="#4fa94d" ariaLabel="rotating-lines-loading" wrapperStyle={{}} wrapperClass="rotating-lines-loading" strokeWidth="5" animationDuration="0.75" visible={true} />
        </div>
      ) : (
        <>
          {dataBank.map((x, key) => {
                      ...
                      <div className="col-lg-7 col-md-12">
                        <div className="payment-deadline">
                          <div className="deadline-date">
                            ...
                            <p>
                              {d_names[day] + ", " + (parseInt(date) < 10 ? "0" + date : date) + " " + m_names[month] + " " + year} jam {(parseInt(hour) < 10 ? "0" + hour : hour) + "." + (parseInt(min) < 10 ? "0" + min : min)} WIB
                            </p>
                          </div>
                          <HitunganHari />
                        </div>
                        <div className="transfer-detail">
                          ...
                          <div className="total-payment">
                            <p className="price-to-pay">Rp {currencyFormat(Total)}</p>
                            <button
                              onClick={() => {
                          ...
                          <div className="content-tabs">
                            <div className={toggleState === 1 ? "content active-content" : "content"}>
                              <ul>
                                ...
                                <li>
                                  Masukkan nomor {x.name} Virtual Account: 70020+Order ID
                                  <br />
                                  Contoh:
                                  <br />
                        ...
                        <div className="confirm-payment">
                          {confirm === "confirm" ? (
                            <div className="confirm-click">
                              ...
                              <button onClick={() => setConfirm("confirm-payment")}>Konfirmasi Pembayaran</button>
                            </div>
                          ) : (
                            <KonfirmasiUpload orderId={orderID} />
                          )}
                        </div>
                      </div>
                    </div>
