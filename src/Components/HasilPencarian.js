...
import "../Assets/hasilpencarian.css";
        ...
        <div className="car-choice">
                  ...
                  {cars.map((car, index) => {
                    return (
                      <div className="col-lg-4 col-md-6" key={index}>
                        {isLoading ? (
                          <Skeleton style={{ marginBottom: "20px", height: "420px" }} />
                        ) : (
                          <div className="card-border">
                            <div className="card">
                              <img src={car.image !== null ? car.image : placeholderImg} className="card-img-top" alt="..." />
          ...
          {emptyData && (
            <div className="noData">
              ...
              <h4>&lsquo;Coba ubah kata kunci atau filter yang kamu gunakan&rsquo;</h4>
            </div>
          )}
        </div>
      </div>
