        ...
        <Col className="loginkiri">
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-group mb-3">
              ...
              <input type="text" placeholder="Nama Lengkap" className="form-control " value={name} onChange={(event) => setName(event.target.value)} required />
            </div>
            <div className="form-group mb-3">
              <label className="text-start pb-3">Email*</label>
              <input type="email" placeholder="Contoh: johndoe@gmail.com" className="form-control " value={email} onChange={(event) => setEmail(event.target.value)} required />
            </div>
